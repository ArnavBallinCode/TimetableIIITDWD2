...
class TestElectiveAllotment(unittest.TestCase):
    ...
    def test_elective_allocation(self):
        ...
        elective_entries = [e for e in scheduler.scheduled_entries if e["code"].startswith("Elective_")]
        ...
        core_entries = [e for e in scheduler.scheduled_entries if not e["code"].startswith("Elective_")]
